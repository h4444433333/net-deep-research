...
## Research Faster. Cite Better. Sound More Certain For The Right Reasons.

`Net Deep Research` is a production-grade skill bundle for agents that need live web research, careful source filtering, and evidence organization before answering. Compared with answering directly, this skill significantly improves the reliability of research results.
...
- 🔎 **Live multi-source research**, not one-shot guessing
- 🛡️ **URL safety checks** before fetching, so risky links are filtered first
- 📚 **Backend-assisted source reputation** for more reliable source selection
- 🧭 **Structured answer workflow** with evidence-first reasoning
- 🔁 **Cross-verification** built into every answer
- ⚡ **Visible supporting evidence** so answers are traceable, with evidence and reasons shown for the user to decide whether to adopt the answer
